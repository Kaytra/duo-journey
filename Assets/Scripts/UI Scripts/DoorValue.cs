...
{
    private GameObject hinge, collectableManager;
    public GameObject equalScreenFrame, underScreenFrame, equalEffect, underEffect, valueCanvas;
    public TextMeshProUGUI reqValueTxt;
    private int value;
    // Start is called before the first frame update
    void Start()
    {
        hinge = GameObject.FindGameObjectWithTag("Hinge");
